  ...
  return (
    <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
      ...
      <button
        type="submit" 
        disabled={isLoading} 
        className="mt-2 w-full rounded-xl bg-gradient-to-r from-indigo-500 to-teal-400 px-4 py-3 font-semibold text-white shadow-glow transition-all hover:scale-[1.01] hover:opacity-90 active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-60"
      >
